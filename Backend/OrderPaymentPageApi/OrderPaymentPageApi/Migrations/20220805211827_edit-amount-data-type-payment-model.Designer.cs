...
namespace OrderPaymentPageApi.Migrations
{
    ...
    [Migration("20220805211827_edit-amount-data-type-payment-model")]
    partial class editamountdatatypepaymentmodel
    {
            ...
            modelBuilder.Entity("OrderPaymentPageApi.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DateOrdered")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 5, 23, 18, 26, 721, DateTimeKind.Local).AddTicks(9133));
            ...
            modelBuilder.Entity("OrderPaymentPageApi.Models.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 5, 23, 18, 26, 722, DateTimeKind.Local).AddTicks(1719));
